# -*- coding: utf-8 -*-
"""
Created on Mon Jun 26 19:17:24 2023
...
maze = cv2.imread("C:/Users/swami/ARKPerceptionSwaminathanSK/ARK Task 2023/maze.png", 0)

# Declaring some boundaries using coordinates obtained from cursor pointing. This is with some uncertainty but is an upper bound to the C-space at the start and end points.
YMax = 334
YMin = 21
XMax = 448
print(maze.shape)
